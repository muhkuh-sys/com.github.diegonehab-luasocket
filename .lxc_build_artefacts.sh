...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/com.github.diegonehab-lua*-luasocket/targets/jonchki/repository/com/github/diegonehab/luasocket/*" -type f'`
echo ${FILELIST}
