...
node {
    def ARTIFACTS_PATH = 'build/repository/com/github/diegonehab/luasocket/*'
        ...
        stage(atEntry[0]){
            docker.image("${atEntry[2]}").inside('-u root') {
                ...
                checkout([$class: 'GitSCM',
                    ...
                    submoduleCfg: [],
                    userRemoteConfigs: [[url: 'https://github.com/muhkuh-sys/com.github.diegonehab-luasocket.git']]
                ])
